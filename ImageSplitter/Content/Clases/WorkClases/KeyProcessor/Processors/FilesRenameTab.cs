...
{
    /// <summary>
    /// Класс обработки нажатия на хоткей, для вкладки переименования файлов
    /// </summary>
    internal class FilesRenameTab : IHotKeyProcessor
    {
        /// <summary>
        ...
        public FilesRenameTab(MainWork mainWork)
        {
